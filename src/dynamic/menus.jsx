    ...
    key: "JavaScript笔记",
    children: [{
    label: "JavaScript面向对象",
    key: "JavaScript面向对象",
    children: [{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/JavaScript创建对象的方法">JavaScript创建对象的方法</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/JavaScript创建对象的方法",
},
{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/class和js普通构造函数">class和js普通构造函数</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/class和js普通构造函数",
},
{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/js的继承">js的继承</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/js的继承",
},
{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/对象的属性">对象的属性</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/对象的属性",
},
{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/神奇的JavaScript构造函数">神奇的JavaScript构造函数</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/神奇的JavaScript构造函数",
},
{
label: <NavLink to="/JavaScript笔记/JavaScript面向对象/部门分享">部门分享</NavLink>,
key: "/JavaScript笔记/JavaScript面向对象/部门分享",
},
],
  },{
label: <NavLink to="/JavaScript笔记/promise与setTimeout">promise与setTimeout</NavLink>,
key: "/JavaScript笔记/promise与setTimeout",
},
{
label: <NavLink to="/JavaScript笔记/手写实现bind">手写实现bind</NavLink>,
key: "/JavaScript笔记/手写实现bind",
},
{
label: <NavLink to="/JavaScript笔记/手动实现数组的map方法">手动实现数组的map方法</NavLink>,
key: "/JavaScript笔记/手动实现数组的map方法",
},
{
label: <NavLink to="/JavaScript笔记/闭包与箭头函数">闭包与箭头函数</NavLink>,
key: "/JavaScript笔记/闭包与箭头函数",
},
{
    label: "高阶函数及运用",
    key: "高阶函数及运用",
    children: [{
label: <NavLink to="/JavaScript笔记/高阶函数及运用/AOP面向切片编程">AOP面向切片编程</NavLink>,
key: "/JavaScript笔记/高阶函数及运用/AOP面向切片编程",
},
{
label: <NavLink to="/JavaScript笔记/高阶函数及运用/after">after</NavLink>,
key: "/JavaScript笔记/高阶函数及运用/after",
},
{
label: <NavLink to="/JavaScript笔记/高阶函数及运用/transaction事务">transaction事务</NavLink>,
key: "/JavaScript笔记/高阶函数及运用/transaction事务",
},
{
    label: "二级路由",
    key: "二级路由",
    children: [{
label: <NavLink to="/JavaScript笔记/高阶函数及运用/二级路由/test">test</NavLink>,
key: "/JavaScript笔记/高阶函数及运用/二级路由/test",
},
],
  },],
  },],
...
label: <NavLink to="/常用小工具集合">常用小工具集合</NavLink>,
key: "/常用小工具集合",
},
{
    label: "最佳实践",
